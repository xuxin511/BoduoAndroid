...
import static com.liansu.boduowms.modules.outstock.purchaseReturn.purchaseInspection.scan.PurchaseInspectionProcessingModel.BARCODE_TYPE_BULK;
import static com.liansu.boduowms.modules.outstock.purchaseReturn.purchaseInspection.scan.PurchaseInspectionProcessingModel.BARCODE_TYPE_OUT_BARCODE;
import static com.liansu.boduowms.modules.outstock.purchaseReturn.purchaseInspection.scan.PurchaseInspectionProcessingModel.BARCODE_TYPE_PALLET_NO;
import static com.liansu.boduowms.modules.outstock.purchaseReturn.purchaseInspection.scan.PurchaseInspectionProcessingModel.SCAN_TYPE_PALLET_NO;
        ...
        mModel.requestBarcodeInfoRefer(info, new NetCallBackListener<String>() {
            ...
            public void onCallBack(String result) {
                try {
                    ...
                    if (returnMsgModel.getResult() == RESULT_TYPE_OK) {
                        BaseMultiResultInfo<Boolean, Void> checkResult = mModel.checkAndUpdateMaterialInfo(returnMsgModel.getData(), true);
