 ...
 */
public class NewSettingPrintingPresenter {
    private Context              mContext;
    private NewSettingModel      mModel;
    private INewSettingPrintView mView;
    ...
    public NewSettingPrintingPresenter(Context context, INewSettingPrintView view, MyHandler<BaseFragment> handler) {
        this.mContext = context;
        this.mView = view;
        this.mModel = new NewSettingModel(context, handler);
        this.mPrintModel = new PrintBusinessModel(context, null);
        onReadData();
    }

    public NewSettingModel getModel() {
        return mModel;
    }
