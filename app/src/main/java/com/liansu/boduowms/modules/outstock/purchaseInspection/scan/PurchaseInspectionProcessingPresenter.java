...
import static com.liansu.boduowms.modules.outstock.purchaseInspection.scan.PurchaseInspectionProcessingModel.BARCODE_TYPE_BULK;
    ...
    public void onBarCodeScan(String fatherBarcode, String subBarcode, int operationType, float scanQty) {
        try {
            ...
            if (operationType == PurchaseInspectionProcessingModel.SCAN_TYPE_SUB_BARCODE) {
                ...
                if (scanSubQRCode.getBarcode().contains("%") && scanSubQRCode.getSerialno() == null ) { //外箱条码
