...
public class ReprintPalletLabel extends BaseActivity implements IReprintPalletLabelView, RadioGroup.OnCheckedChangeListener, IUserSettingView {
...
//    }
    ...
    public void requestAreaNo(AreaInfo info) {
        ...
        LogUtil.WriteLog(ReprintPalletLabel.class, TAG_GET_T_AREA_MODEL, modelJson);
    ...
    private void resultAreaInfoQuery(String result) {
        LogUtil.WriteLog(ReprintPalletLabel.class, TAG_GET_T_AREA_MODEL, result);
        try {
    ...
    public void requestMaterialInfo(String material) {
        ...
        LogUtil.WriteLog(ReprintPalletLabel.class, TAG_SELECT_MATERIAL, modelJson);
    ...
    private void resultMaterialInfoQuery(String result) {
        try {
            LogUtil.WriteLog(ReprintPalletLabel.class, TAG_SELECT_MATERIAL, result);
    ...
    public void resultQueryStockInfo(String result) {
        LogUtil.WriteLog(ReprintPalletLabel.class, TAG_GET_STOCK_INFO_LIST, result);
        try {
