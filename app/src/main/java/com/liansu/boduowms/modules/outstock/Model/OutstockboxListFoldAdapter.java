...
//拼箱适配器
public class OutstockboxListFoldAdapter extends BaseExpandableListAdapter {

    List<String> mGroupList;//一级List
    List<List<String>> mChildList;//二级List 注意!这里是List里面套了一个List<String>,实际项目你可以写一个pojo类来管理2层数据

    public OutstockboxListFoldAdapter(List<String> groupList, List<List<String>> childList){
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        convertView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_offshelfscandetail_listview, parent,false);
