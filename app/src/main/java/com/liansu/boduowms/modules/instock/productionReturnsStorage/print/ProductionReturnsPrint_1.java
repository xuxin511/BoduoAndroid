...
public class ProductionReturnsPrint_1 extends BaseActivity implements IProductionReturnsStorageView {
    private static final int REQUEST_CODE_OK = 1;
    Context mContext = ProductionReturnsPrint_1.this;
    ...
    @Override
    public void createDialog(OrderDetailInfo info) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.menu_sale_return_icon) {
            ...
            intent.setClass(ProductionReturnsPrint_1.this, ProductionReturnStorageScan.class);
