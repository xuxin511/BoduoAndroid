 ...
 * @desc: 库内菜单管理
 * @author: Nietzsche
 * @time 2020/6/25 17:17
 */
@ContentView(R.layout.fragment_menu)
public class InHouseManagementMenuFragment extends BaseFragment implements IMenuView {

    @ViewInject(R.id.gv_Function)
    GridView mGridView;
    GridViewItemAdapter mAdapter;
    Context             mContext = getActivity();
    private InHouseManagementMenuPresenter mPresenter;
