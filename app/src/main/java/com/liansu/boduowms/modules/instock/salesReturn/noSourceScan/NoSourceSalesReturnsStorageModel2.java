 ...
 */
public class NoSourceSalesReturnsStorageModel2 extends InStockReturnsStorageScanModel {
    public NoSourceSalesReturnsStorageModel2(Context context, MyHandler<BaseActivity> handler) {
        super(context, handler);
    }

    public NoSourceSalesReturnsStorageModel2(Context context, MyHandler<BaseActivity> handler, int voucherType, int businessType) {
    ...
    public void requestOrderRefer(List<OrderDetailInfo> list, NetCallBackListener<String> callBackListener) {
        ...
        RequestHandler.addRequestWithDialog(Request.Method.POST, TAG_POST_T_SUB_ORDER_RETURN_DETAIL_ADF_ASYNC, mContext.getString(R.string.Msg_order_refer), mContext, mHandler, RESULT_TAG_POST_T_SUB_ORDER_RETURN_DETAIL_ADF_ASYNC, null, UrlInfo.getUrl().PostT_SaleReturnDetailADFAsync, modelJson, null);
