 ...
 * @return:
 * @author: Nietzsche
 * @time 2020/7/15 10:16
 */
public class ProductStorageBillModel extends BaseOrderBillChoiceModel {
    ...
    public ProductStorageBillModel(Context context, MyHandler<BaseActivity> handler) {
     ...
     */
    public void requestProductStorageOrderList(OrderRequestInfo orderHeaderInfo, NetCallBackListener<String> callBackListener) {
