...
public class PurchaseInspectionScanAdapter extends RecyclerView.Adapter<PurchaseInspectionScanAdapter.ViewHolder> {
    private Context                       context; // 运行上下文
    private List<OutStockOrderDetailInfo> receiptDetailModels; // 信息集合
    private LayoutInflater                listContainer; // 视图容器
    private String                  receiptType = "";


    public PurchaseInspectionScanAdapter(Context context, String ReceiptType, List<OutStockOrderDetailInfo> receiptDetailModels) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        OutStockOrderDetailInfo receiptDetailModel = receiptDetailModels.get(position);
