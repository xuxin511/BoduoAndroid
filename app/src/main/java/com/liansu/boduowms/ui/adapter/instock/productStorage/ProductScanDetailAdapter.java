...
public class ProductScanDetailAdapter extends RecyclerView.Adapter<ProductScanDetailAdapter.ViewHolder> {
    private Context                 context; // 运行上下文
    private List<ProductDetailInfo> receiptDetailModels; // 信息集合
    private LayoutInflater          listContainer; // 视图容器
    private String                  receiptType = "";


    public ProductScanDetailAdapter(Context context, String ReceiptType, List<ProductDetailInfo> receiptDetailModels) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ProductDetailInfo receiptDetailModel = receiptDetailModels.get(position);
...
//        holder.txtBatchNo.setText("批次:"+receiptDetailModel.getBatchno());
        ...
        holder.txtScanNum.setText("已打印：" + receiptDetailModel.getScanqty());
        holder.txtRemainQty.setText("待打印：" + receiptDetailModel.getRemainqty());
