...
import com.liansu.boduowms.bean.qualitySpection.QualityDetailInfo;
...
public class QualityInspectionScanAdapter extends RecyclerView.Adapter<QualityInspectionScanAdapter.ViewHolder> {
    private Context                 context; // 运行上下文
    private List<QualityDetailInfo> receiptDetailModels; // 信息集合
    private LayoutInflater          listContainer; // 视图容器
    private String                  receiptType = "";


    public QualityInspectionScanAdapter(Context context, String ReceiptType, List<QualityDetailInfo> receiptDetailModels) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        QualityDetailInfo receiptDetailModel = receiptDetailModels.get(position);
