...
public class ReprintLabelAdapter extends RecyclerView.Adapter<ReprintLabelAdapter.ViewHolder> implements View.OnClickListener {
    ...
    public ReprintLabelAdapter(Context context, List<StockInfo> list) {
