...
public class QueryStockDetailAdapter extends RecyclerView.Adapter<QueryStockDetailAdapter.ViewHolder> implements View.OnClickListener {
    ...
    public QueryStockDetailAdapter(Context context, List<StockInfo> list) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_query_stock, parent, false);
