...
import com.liansu.boduowms.ui.adapter.instock.SupplierModel;
...
public class UpshelfBillChioceItemAdapter extends BaseAdapter {
    ...
    private List<OrderHeaderInfo>    inStockTaskInfoModels; // 信息集合
    ...
    public UpshelfBillChioceItemAdapter(Context context, List<OrderHeaderInfo> inStockTaskInfoModels) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        OrderHeaderInfo inStockTaskInfoModel = inStockTaskInfoModels.get(selectID);
        listItemView.txtTaskNo.setText(inStockTaskInfoModel.getErpvoucherno());
        listItemView.txtERPVoucherNo.setText(inStockTaskInfoModel.getVoucherno());
        listItemView.txtStrVoucherType.setText(inStockTaskInfoModel.getErpvoucherno());
