...
public class NetworkHelper {
     ...
     * 将参数转换为字符串
     */
    public static String convertObjectMapToString(Map<String, Object> params) {
        StringBuffer content = new StringBuffer();
        List<String> keys = new ArrayList<>(params.keySet());
        for (int i = 0; i < keys.size(); i++) {
            String key = keys.get(i);
     ...
     * @return
     */
    public static Map<String, Object> getURLEncodeObjectParams(Map<String, Object> params) {
     ...
     * @return
     */
    public static String getUrlWithObjectParams(String url, Map<String, Object> params) {
        if (params == null || params.isEmpty()) {
            return url;
        }
        params = getURLEncodeObjectParams(params);
        String paramsStr = convertObjectMapToString(params);
        if (!url.endsWith("?")) {
            url += "?";
        }
        url += paramsStr;
